...
export default async function AccountPage() {
	...
	return (
		<main className="mx-auto flex w-full max-w-3xl flex-col gap-6 px-6 py-16 text-white">
			...
			<div className="rounded-2xl border border-violet-500/50 shadow-md shadow-violet-500/20 bg-white/5 p-6">
			...
			<div className="rounded-2xl border border-violet-500/50 shadow-md shadow-violet-500/20 bg-white/5">
				<Table>
					<TableHeader>
						<TableRow>
